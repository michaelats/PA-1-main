					...
					<div class="col-md-12">
						...
						<div class="post-blog" data-aos="flip-up">
							...
							<div class="blog-content">
								...
								<p style="text-align: justify;"> <?php echo substr(strip_tags(str_replace(PHP_EOL, '<br>', $infowisata->daftar_informasi_wisata), '<br>'), 0, 350);?> <a href="/lengkapPengguna/{{$infowisata ->id_info_wisata}}"> Lihat selengkapnya...</a></p>
							</div> <!-- /.blog-content -->
						</div> <!-- /.post-blog -->
						@endforeach
					</div> <!-- /.col-md-12 -->
