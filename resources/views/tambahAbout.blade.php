			...
			<div class="row">
				<div class="col-md-12">
					<div class="contact-form">
						...
						<form action="{{route('tentangKami.tambah')}}" method="post" id="contact-form" enctype="multipart/form-data">	
                            {{ csrf_field() }}
							<div class="row my-4">
								<div class="col-md-4">
									<p>
                                ...
                                <div class="col-md-4">
									<p>
										...
										<input id="formFileMultiple" required="required"  name="FotoAboutUs" type="file" id="formFileMultiple" multiple style="width: 100%">
									</p>
								</div>
							</div>
