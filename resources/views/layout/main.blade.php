	...
	<div class="responsive_menu">
        <ul class="main_menu">
            ...
            <li><a href="">Informasi</a>
                <ul>
                    <li><a href="{{url('/informasiWisata')}}">Informasi Wisata Alam</a></li>
					<li><a href="{{url('/kulinerWisata')}}">Informasi Wisata Kuliner</a></li>
					<li><a href="{{url('/budayaWisata')}}">Informasi Wisata Budaya</a></li>
                    <li><a href="{{url('/informasiStatistik')}}">Informasi Statistik</a></li>
                </ul>
            </li>
	...
	<footer class="site-footer">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12"> 
                <center>
                    <a href="{{url('/')}}"><img src="{{asset('img')}}/logo.png" alt="logo harian" class="logoharian"></a>  
