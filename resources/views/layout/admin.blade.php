...
<body>
	...
	<div class="responsive_menu">
        <ul class="main_menu">
            <li><a href="{{url('/indexadmin')}}">Beranda</a></li>
            <li><a href="{{url('/galeriadmin')}}">Galeri</a></li>
            <li><a href="">Informasi</a>
                <ul>
                    <li><a href="{{url('/infoWis')}}">Informasi Wisata</a></li>
					<li><a href="{{url('/kulinerAdmin')}}">Informasi Wisata Kuliner</a></li>
					<li><a href="{{url('/budayaAdmin')}}">Informasi Wisata Budaya</a></li>
                    <li><a href="{{url('/infostatistikAdmin')}}">Informasi Statistik</a></li>
                </ul>
            </li>
            <li><a href="{{url('/tanyaAdmin')}}">Tanya Jawab</a></li>
            <li><a href="{{url('/aboutadmin')}}">Tentang Kami</a></li>
	...
	<footer class="site-footer">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12"> 
                <center>
                    <a href="{{url('/indexadmin')}}"><img src="{{asset('img')}}/logo.png" alt="logo harian" class="logoharian"></a>  
